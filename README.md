...
# This is a two step project to demonstrate adding new service to existing infrastructure.
Part I of the Terraform code creates a new base infrastructure with the associated external IP, load balancer, networks, security groups etc...
Part II of the code uses the existing infrastructure to add new services.
